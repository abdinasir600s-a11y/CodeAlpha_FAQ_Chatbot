    ...
    with st.sidebar:
        ...
        st.markdown(
            ...
            <div class="sidebar-note">
                FAQ dataset contains <strong>{len(FAQ_DATA)}</strong> admission questions.
            </div>
            """,
            unsafe_allow_html=True,
        )
...
def show_header():
    st.markdown(
        ...
        <div class="app-header">
            ...
            <div class="subtitle">Artificial Intelligence Internship - Task 2</div>
            <div class="description">
                Ask university admission related questions and get answers using an
                NLP-based FAQ matching chatbot.
            </div>
        </div>
        """,
        unsafe_allow_html=True,
...
def show_chat_card(chat_item):
    ...
    card_class = "confident" if response["is_confident"] else "fallback"
    ...
    chat_card_html = (
        f'<div class="chat-card {card_class}">'
